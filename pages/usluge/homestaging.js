  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.contentSpacerLeft}>
        <img
          src="../images/homestagingslika.png"
          alt="Home staging"
          className={styles.contentImage}
        />
        <p>
          Kupcima je katkad teško vidjeti potencijal nekretnina koje se prodaju,
          no ukoliko se ona malo uljepša – namještaj se posloži na drugačiji
          način, dodaju se neki detalji, a neki drugi izbace – šanse za prodaju
          su veće! Ova usluga obuhvaća savjetovanje.
        </p>
