  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.contentSpacerLeft}>
        ...
        <p>Opcija uključuje tlocrtni raspored namještaja, rasvjete te 3D vizualizacije.</p>
        <p style={{ fontWeight: '600' }}>Mid Point</p>
        <p>Opcija uključuje tlocrtni raspored namještaja, raspored rasvjete, 3D vizualizacije, popis kupovnog namještaja, popis zidnih i podnih obloga, prijedlog keramičarskih radova, popis materijala namještaja po mjeri</p>
