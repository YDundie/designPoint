  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Desing point - stvaramo bezvremenske interijere s naglaskom na udoban namještaj, skladne boje i hrabre teksture. "
        />
      </Head>
      <div className={styles.imageContainer}>
        <div className={`${styles.imageContent} ${styles.container}`}>
          <h1 className={`${styles.header} ${styles.timesNewRomanFont}`}>
            Stilski interijeri za svako poglavlje života.
          </h1>
          <h4 className={styles.header}>
            U Design Pointu stvaramo bezvremenske interijere s naglaskom na
            udoban namještaj, skladne boje i hrabre teksture.
          </h4>
        </div>
        ...
        <div className={` ${styles.uslugeContainer} ${styles.reveal}`}>
          ...
          <FadeIn>
            <div className={styles.usluge}>
              <Service
                to="/usluge/tlocrt"
                imgPath="./icons/layout.png"
                title="Tlocrtni raspored namještaja"
              ></Service>
              <Service
                to="/usluge/interijer"
                imgPath="./icons/designInt.png"
                title="Dizajn interijera"
              ></Service>
              <Service
                to="/usluge/smarthome"
                imgPath="./icons/smart-home.png"
                title="Smart home"
              ></Service>
            </div>
          </FadeIn>
          <FadeIn>
            <div className={styles.usluge}>
              ...
              ></Service>
              <Service
                to="/usluge/savjetovanje"
                imgPath="./icons/tech-support.png"
                title="Savjetovanje"
              ></Service>
            </div>
          </FadeIn>
        ...
        <div className={` ${styles.designerTable}  ${styles.reveal}`}>
          ...
          <div class={styles.designerTableContent}>
            <FadeIn>
              ...
              <h3 className={styles.timesNewRomanFont}>
                Ja sam Ana-Marija Mustač, vaša dizajnerica interijera, a planski
